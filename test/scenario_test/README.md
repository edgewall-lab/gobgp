...
$ git clone https://github.com/edgewall-lab/gobgp.git
$ cd ./gobgp/test
...
```shell
$ cd $GOPATH/src/github.com/edgewall-lab/gobgp
...
1. Run all test.
    ...
    ```shell
    $ cd $GOPATH/src/github.com/edgewall-lab/gobgp/test/scenario_test
    $ ./run_all_tests.sh
    ...
    OK
